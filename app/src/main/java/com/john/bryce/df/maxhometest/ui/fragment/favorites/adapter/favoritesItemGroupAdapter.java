package com.john.bryce.df.maxhometest.ui.fragment.favorites.adapter;
...
import com.john.bryce.df.maxhometest.ui.fragment.ItemAdapter;
import com.john.bryce.df.maxhometest.ui.wigdet.SnapHelperOneByOne;
...
public class favoritesItemGroupAdapter extends RecyclerView.Adapter<favoritesItemGroupAdapter.MyViewHolder> {

    private Context context;
    private Data data;
    private FragmentManager fragmentManager;

    public favoritesItemGroupAdapter(Context context, Data data, FragmentManager fragmentManager) {
    ...
    @NonNull
    @Override
    public favoritesItemGroupAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from( context ).inflate( R.layout.horizontal_recyclerview_item, parent, false );
        return new favoritesItemGroupAdapter.MyViewHolder( view );
    }

    @Override
    public void onBindViewHolder(@NonNull final favoritesItemGroupAdapter.MyViewHolder holder, int position) {
